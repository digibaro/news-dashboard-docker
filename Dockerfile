...
# Run:    see docker-compose.yaml.default (copy it to docker-compose.yaml)
...
# the version is read from the VERSION file, so a local docker-compose.yaml never goes stale
...
# built-in default; docker-compose.yaml mounts your own config.yaml over it
